                        ...
                        <div class="col-md-4 center">
                            <div class="login-box">
                                ...
                                <form class="m-t-md" action="pages/authentication.php" method="POST">
                                    ...
                                    <a href="forgot_pw.php" class="display-block text-left m-t-md text-md">Forgot Password?</a>
                                     <a href="addstudent.php" class="display-block m-t-md text-md">New User?Register Here</a>
                                </form>
