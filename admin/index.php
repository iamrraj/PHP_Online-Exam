                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                      ...
                                      <a href="departments.php">  <span class="info-box-title">DEPARTMENTS</span></a>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                      ...
                                      <a href="students.php">   <span class="info-box-title">STUDENTS</span></a>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-user"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                       ...
                                       <a href="examinations.php">  <span class="info-box-title">EXAMINATIONS</span></a>
                                    </div>
                                    <div class="info-box-icon">
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                       ...
                                       <a href="subjects.php">  <span class="info-box-title">SUBJECTS</span></a>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-docs"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                       ...
                                       <a href="categories.php">  <span class="info-box-title">CATEGORIES <?php echo "$fp $pp"; ?></span>
                                    </div></a>
                                    <div class="info-box-icon">
                                        <i class="icon-tag"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                       ...
                                       <a href="notice.php">  <span class="info-box-title">NOTICE</span></a>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-list"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                      ...
                                      <a href="questions.php">   <span class="info-box-title">QUESTIONS</span></a>
                                    </div>
                                    <div class="info-box-icon">
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                      ...
                                      <a href="departments.php">   <span class="info-box-title">BANNED STUDENTS</span>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-lock"></i>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="visitors-chart">
                                            <div class="panel-body ">
                                            <div id="chartContainer"  style="height: 370px; max-width: 920px; margin: 0px auto; background-color: "></div>
                                            </div>
                                        </div>
                                    </div>
...
var chart = new CanvasJS.Chart("chartContainer", {
	theme: "light2", // dark2, light1, light2
	exportEnabled: true,
	...
	data: [{
		...
		dataPoints: [
            ...
            { y: <?php echo "$departments"; ?>, label: "Total Departments" },
            { y: <?php echo "$students"; ?>, label: "Total Student" },
            { y: <?php echo "$subjects"; ?>, label: "Total Subjects" },
            { y: <?php echo "$categories"; ?>, label: "Total Category" },
            { y: <?php echo "$notice"; ?>, label: "Total Notice" },
            { y: <?php echo "$examination"; ?>, label: "Total Examination" },
            { y: <?php echo "$banned_students"; ?>, label: "Total Banned" }
